...
import threading
stopuser = {}
token = '7432183389:AAGHiifwyVuqDfWsGq1DvBVviMQFUZPIVVA'
...
IF YOU WANT TO USE BOT YOU MUST HAVE SUBSCRIPTION 
...
◆ 𝑻𝑨𝑲𝑬𝑵 ➜ {"{:.1f}".format(execution_time)} secounds .</b>'''
					if 'success' in last:
						tok = '7432183389:AAGHiifwyVuqDfWsGq1DvBVviMQFUZPIVVA'
						acc =  '2201722670'
						mg = f"""<b> 
❆═══» LAKSHAY 𝚂𝙲𝚁𝙰𝙿𝙿𝙴𝚁 «═══❆
｢𝙲𝙲」➔ <code>{cc}</code>
